...
angular.module('pendingworkorder_reports', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/pendingworkorder_reports', {
    templateUrl: 'pendingworkorder_report/pendingworkorder_report.html',
    controller: 'pendingCtrl'
  });
}])

.controller('pendingCtrl', ['$scope', '$http','$location','$window','$rootScope',
  function($scope, $http,$location,$window,$rootScope) {
$scope.pw_list=function(){
...
$http({
    ...
    method:'GET',
    url:$rootScope.api_url+'breakdown_report_pending?from_date='+$scope.bwo_fields.from_date+'&&to_date='+$scope.bwo_fields.to_date+'&&machine_id='+$scope.bwo_fields.machine_id+'&&shift_id='+$scope.bwo_fields.shift_id+'&&service_engineer_id='+$scope.bwo_fields.service_engineer_id
  })
  .then(function(response){
