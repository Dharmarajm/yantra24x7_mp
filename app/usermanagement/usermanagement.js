...
$rootScope.tenant=$scope.tenant_id;
 ...
 $scope.userregistration = {id: null,first_name:"",last_name:"",email_id:"",password:"",phone_number:"", remarks: "",usertype_id: 1,approval_id: 1,role_id:null,tenant_id: $scope.tenant_id};
$scope.username=localStorage.getItem("username");
$scope.userForm= function(){  

        var userregistration = {first_name:$scope.userregistration.first_name,last_name:$scope.userregistration.last_name,email_id:$scope.userregistration.email_id,password:$scope.userregistration.password,phone_number:$scope.userregistration.phone_number, remarks: $scope.userregistration.remarks,usertype_id:$scope.userregistration.usertype_id,approval_id:$scope.userregistration.approval_id,role_id:$scope.userregistration.role_id,tenant_id: $scope.tenant_id};
